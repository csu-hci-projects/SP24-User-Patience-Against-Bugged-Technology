    ...
    <body>
        ...
        <div class="question-container">
            ...
            <h5><center>Dogs or cats?</center><h5>
                <div>
                    <input type="radio" value="Dogs" id="Q26A1" name="Q26"/>
                    <label for="Q26A1">Dogs</label>
                </div>
                <div>
                    <input type="radio" value="Cats" id="Q26A2" name="Q26"/>
        ...
        <div class="question-container">
            ...
            <h5 class = "hover-heading"><center><span>White, milk, or dark chocolate?</span></center><h5>
                ...
                <div>
                    <input type="radio" value="Milk" id="Q27A2" name="Q27"/>
                    <label for="Q27A2">Milk</label>
                </div>
                <div>
                    <input type="radio" value="Chocolate" id="Q27A3" name="Q27"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Do you prefer waffles or pancakes?</center><h5>
                <div>
                    <input type="radio" value="Waffles" id="Q28A1" name="Q28"/>
                    <label for="Q28A1">Waffles</label>
                </div>
                <div>
                    <input type="radio" value="Pancakes" id="Q28A2" name="Q28"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Would you rather have a sweet or savory breakfast?</center><h5>
                <div>
                    <input type="radio" value="Sweet" id="Q29A1" name="Q29"/>
                    <label for="Q29A1">Sweet</label>
                </div>
                <div>
                    <input type="radio" value="Savory" id="Q29A2" name="Q29"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Do you prefer to wear more masculine or feminine clothes?</center><h5>
                <div>
                    <input type="radio" value="Masculine" id="Q30A1" name="Q30"/>
                    <label for="Q30A1">Masculine</label>
                </div>
                <div>
                    <input type="radio" value="Feminine" id="Q30A2" name="Q30"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Do you like morning or night showers better?</center><h5>
                <div>
                    <input type="radio" value="Morning" id="Q31A1" name="Q31"/>
                    <label for="Q31A1">Morning</label>
                </div>
                <div>
                    <input type="radio" value="Night" id="Q31A2" name="Q31"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Vampires or werewolves?</center><h5>
                <div>
                    <input type="radio" value="Vampires" id="Q32A1" name="Q32"/>
                    <label for="Q32A1">Vampires</label>
                </div>
                <div>
                    <input type="radio" value="Werewolves" id="Q32A2" name="Q32"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Burritos or tacos?</center><h5>
                <div>
                    <input type="radio" value="Burritos" id="Q33A1" name="Q33"/>
                    <label for="Q33A1">Burritos</label>
                </div>
                <div>
                    <input type="radio" value="Tacos" id="Q33A2" name="Q33"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Do you prefer dawn or dusk?</center><h5>
                ...
                <div>
                    <input type="radio" value="Dawn" id="Q34A2" name="Q34"/>
        ...
        <div class="question-container">
            ...
            <h5><center>Do you sleep on the left or the right side of the bed?</center><h5>
                <div>
                    <input type="radio" value="Left" id="Q35A1" name="Q35"/>
                    <label for="Q35A1">Left</label>
                </div>
                <div>
                    <input type="radio" value="Right" id="Q35A2" name="Q35"/>
